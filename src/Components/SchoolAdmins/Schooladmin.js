            ...
            <section class="home-section">
                <nav style={{ height:'10%', backgroundColor:'#e7e3e3'}}>
                    ...
                    <div class="profile-details" id="profile-details">
                        ...
                        <i class='bx bx-log-out' style="padding-left: 15px;"></i>
                ...
                <div class="home-content">
                    ...
                    <div class="sales-boxes">
                        <div class="recent-sales box">
                            <div class="title table-header">Manage Users</div>
                            <div class="sales-details">
                                ...
                                <ul class="details">
                                    <li class="topic">College</li>
                                    <li><a href="#">UT Arlington</a></li>
                                    <li><a href="#">UTD</a></li>
                                    <li><a href="#">UNT</a></li>
                                    <li><a href="#">T Arlington</a></li>
                                    <li><a href="#">UT Arlington</a></li>
                                    <li><a href="#">UTD</a></li>
                                    <li><a href="#">UNT</a></li>
                                    <li><a href="#">T Arlington</a></li>
                            ...
                            <div class="button">
                                <a href="allprofiles.html">See All</a>
                            </div>
                        </div>
                        <div class="top-sales box">
                            <div class="title table-header">Top Stories</div>
                            <ul class="top-sales-details">
                                <li>
                                    <a href="#">

                                        <span class="product">Topic</span>
                                    </a>
                                    <span class="price">Posted on 23-08-2005</span>
                        ...
                        <div class="top-sales box">
                            <div class="title table-header">Clubs</div>
                            <ul class="top-sales-details">
                                <li>
                                    <a href="#">

                                        <span class="product">Club Name</span>
                                    </a>
                                    <span class="price">
                                        <div class="button">
                                            <a href="/schoolAdminClub.html">View in detail</a>
                                        </div>
                                    </span>
